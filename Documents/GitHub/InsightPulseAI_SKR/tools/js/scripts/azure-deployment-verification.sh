...
STATIC_WEBAPP_NAME=${STATIC_WEBAPP_NAME:-"delightful-glacier-03349aa0f.6.azurestaticapps.net"}
BASE_URL="https://$STATIC_WEBAPP_NAME.azurestaticapps.net"
...
URLS=(
  ...
  "/advisor/index.html"
  "/advisor/assets/index-Dct1RWoA.js"
...
if ! curl -s --head "$BASE_URL" > /dev/null; then
  ...
  echo -e "1. The Static Web App name is correct"
