/**
 * Scout Advanced Analytics (Market Intelligence) Visualizer
 *
 * A JavaScript library for rendering GenAI-powered insights from Scout Advanced Analytics
...
class InsightsVisualizer {
  ...
  useFallbackInsights() {
    ...
    this.metadata = {
      ...
      model: 'scout-advanced-analytics-fallback',
