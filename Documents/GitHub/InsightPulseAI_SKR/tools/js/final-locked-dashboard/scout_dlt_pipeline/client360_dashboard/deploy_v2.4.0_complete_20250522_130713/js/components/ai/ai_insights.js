/**
 * AI Insights Component - Client360 Dashboard v2.3.3
...
function loadAIInsights() {
  ...
  // Use AI Insights Provider to get insights
  if (window.aiInsightsProvider) {
    ...
    // Fallback to direct fetch if provider isn't available
...
// Export the render function so it can be called from other modules
