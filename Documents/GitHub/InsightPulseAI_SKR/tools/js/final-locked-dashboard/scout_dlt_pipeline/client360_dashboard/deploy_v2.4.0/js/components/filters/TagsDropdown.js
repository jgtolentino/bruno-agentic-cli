...
class TagsDropdown {
  constructor(containerId, options = {}) {
    ...
    this.availableTags = [
      { id: 'high-performance', label: 'High Performance', color: '#28a745' },
      { id: 'trending', label: 'Trending', color: '#ffc107' },
      { id: 'seasonal', label: 'Seasonal', color: '#17a2b8' },
      { id: 'premium', label: 'Premium', color: '#6f42c1' },
      { id: 'budget-friendly', label: 'Budget Friendly', color: '#20c997' },
      { id: 'new-arrival', label: 'New Arrival', color: '#fd7e14' },
      { id: 'bestseller', label: 'Bestseller', color: '#e83e8c' },
      { id: 'limited-time', label: 'Limited Time', color: '#dc3545' },
      { id: 'family-pack', label: 'Family Pack', color: '#6c757d' },
      { id: 'organic', label: 'Organic', color: '#28a745' }
    ];
