...
# Deploy Client360 Dashboard with Sample Data
# This script handles deployment of the dashboard including the sample data package
...
echo -e "${BLUE}=== Client360 Dashboard Deployment With Sample Data ===${NC}"
...
# Client360 Dashboard Data

This directory contains data files used by the Client360 Dashboard:
...
DEPLOY_PACKAGE="${OUTPUT_DIR}/client360_dashboard_with_sample_data_${TIMESTAMP}.zip"
