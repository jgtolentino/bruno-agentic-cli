#!/bin/bash
# setup_azure_resources.sh - Configure Azure resources for Juicer GenAI Insights
# This script sets up the required Azure resources for deploying the Juicer GenAI Insights system
...
LOCATION="eastus2"
STORAGE_ACCOUNT_NAME="juicerinsights$(date +%Y%m%d)"
DATABRICKS_WORKSPACE_NAME="juicer-databricks"
STATIC_WEB_APP_NAME="juicer-insights-dashboard"
