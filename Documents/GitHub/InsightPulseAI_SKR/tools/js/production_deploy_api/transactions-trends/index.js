module.exports = async function (context, req) {
    ...
    try {
        // Return comprehensive mock data for Transaction Trends POC
        const mockData = {
            hourlyVolume: [
                ...
                { hour: 14, transactionCount: 73, avgAmount: 167.20, avgDuration: 38.7, label: "14:00", tooltip: "73 transactions at 14:00" },
                { hour: 15, transactionCount: 59, avgAmount: 112.65, avgDuration: 31.2, label: "15:00", tooltip: "59 transactions at 15:00" },
                { hour: 16, transactionCount: 68, avgAmount: 145.30, avgDuration: 33.8, label: "16:00", tooltip: "68 transactions at 16:00" }
            ],
            ...
            summaryStats: {
                totalTransactions: 547,
                transactionsWithDuration: 521,
                transactionsWithAmount: 539,
                ...
                durationCompleteness: '95.2',
                amountCompleteness: '98.5'
            },
            metadata: {
                generatedAt: new Date().toISOString(),
                dataSource: 'transaction_trends_poc_mock_v3',
                request: {
        ...
        context.log(`Success: returning ${mockData.summaryStats.totalTransactions} transactions`);
        ...
        context.res = {
            ...
            body: JSON.stringify({
                ...
                message: 'Failed to fetch transaction trends data',
