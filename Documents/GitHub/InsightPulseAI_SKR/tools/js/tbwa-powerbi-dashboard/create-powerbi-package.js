...
function createZipPackage() {
  try {
    ...
    console.log(`Created zip package: ${packageName}`);
  } catch (error) {
...
console.log(`Zip package: ${packageName}`);
console.log(`\nTo deploy to Azure Static Web Apps:`);
console.log('1. Go to Azure Portal and create a new Static Web App');
console.log('2. Select "Custom upload" during deployment');
console.log('3. Upload the generated zip file');
console.log('4. Access your Power BI dashboard at: https://your-site.azurestaticapps.net/powerbi');